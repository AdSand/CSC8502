...
OGLRenderer::OGLRenderer(Window &window)	{
	...
	int attribs[] = {
		...
		,WGL_CONTEXT_PROFILE_MASK_ARB, WGL_CONTEXT_COMPATIBILITY_PROFILE_BIT_ARB,		// CHANGED THIS SO THAT IT WOULDNT BREAK
...
void OGLRenderer::SetTextureRepeating(GLuint target, bool repeating)
{
	...
	// Set properties on whatever is bound to the OpenGL state machine
